document.addEventListener("DOMContentLoaded", () => {
  ...
  "33": "images/faustathon2_logo.png",
};
...
function scrollEventMatchIntoView(query) {
...
function renderHoraroLink(horaroUrl) {
  ...
  eventTypeSearch += e.key.toLowerCase();

  clearTimeout(eventTypeSearchTimer);
  eventTypeSearchTimer = setTimeout(() => {
    eventTypeSearch = "";
  }, 900);

  scrollEventMatchIntoView(eventTypeSearch);
});
...
defaultItem.dataset.value = "Select an event";
